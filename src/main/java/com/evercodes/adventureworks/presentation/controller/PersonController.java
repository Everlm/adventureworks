...
@Tag(name = "Person", description = "CRUD de Personas")
@RestController
...
public class PersonController {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<Result<PersonResponse>> update(@PathVariable Integer id, @RequestBody PersonRequest request) 
    {
